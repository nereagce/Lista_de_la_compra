...
public class MinimosBBDD extends Worker {

    public MinimosBBDD(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        //Realizamos l apetición al servidor
        String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/ngonzalez114/WEB/minimos.php";
        ...
        //Si la respuesta no es 200 OK informaremos del fallo
