...
public class SubirFotoBBDD extends Worker {
    public SubirFotoBBDD(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/ngonzalez114/WEB/subirFoto.php";
