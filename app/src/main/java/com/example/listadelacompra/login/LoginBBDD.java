...
public class LoginBBDD extends Worker {

    public LoginBBDD(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/ngonzalez114/WEB/login.php";
        ...
        try {
            ...
            if (statusCode == 200) {//Si es 200 OK
                ...
                Log.i("Result",result);
                inputStream.close();
                //Enviamos el resultado con los datos
        ...
        //Si el resultado no es 200 OK nos devolverá un fallo
